...
const NightMode = observer(() => {
  ...
  return (
    <main>
      <div className="bottom-6 flex items-center gap-x-3">
        <svg width="17" height="16" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill={isDarkMode ? "#fff" : "#5A6069"}
          />
        </svg>
        <button
          onClick={changeMode}
          className="relative flex h-6 w-12 cursor-pointer items-center rounded-full bg-black-200 p-2"
