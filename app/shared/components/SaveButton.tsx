...
class Button extends Component<btns> {
    render() {
        ...
        return (
            <main>
                <button
                    ...
                    className="flex justify-center items-center gap-3 p-2 h-45 w-[40px] md:w-152 bg-orange-600 rounded-lg cursor-pointer hover:bg-orange-400"
                >
