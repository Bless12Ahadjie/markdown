...
const MarkdownView = observer(() => {
    ...
    const handleContentChange: (event: ChangeEvent<HTMLTextAreaElement>) => void = (event) => {
    ...
    return (
        <main
        className={`h-[calc(100vh-65px)] ${previewSelected ? "hidden " : "w-1/2"} relative mt-[70px] ${isSidebarOpen? "w-[640px]" : 'w-1/2'}`}
        >
